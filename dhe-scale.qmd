...
|-------|--------------------------------|------|------|
| May 2024 | A **Scoping review** of mechanisms explaining socioeconomic disparities in digital health outcomes | COMPLETE | — |
| Jun 2024 | A **Literature review** of existing digital health scales to identify gaps and inform item development | Complete | — |
| Sep 2024 | **Proto-model development** from existing theory | Complete | — |
| Nov 2024 | **Semi-structured interviews** with users on digital health experiences | Complete | |
| Jan 2025 | **Delphi study** with subject matter experts to establish content validity | Complete | |
| Mar 2025 | **Cognitive interviews** with users on the draft scale | Complete | |
| Apr 2025 | **Pilot study** of the draft DHES | Complete | |
| May 2025 | **Full scale testing** with UK adult sample | Ongoing | |
| TBC | **Psychometric evaluation** of structural validity and measurement properties | Planned | — |
| TBC | **Validation study** examining convergent, divergent, and criterion validity | Planned | — |
